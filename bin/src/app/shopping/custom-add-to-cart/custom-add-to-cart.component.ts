...
//  styleUrls: ['./custom-add-to-cart.component.css']
//})
 ...
 */
@Component({
	selector: 'custom-add-to-cart', // tslint:disable-line component-selector
	templateUrl: './custom-add-to-cart.component.html',
})
export class CustomAddToCartComponent implements OnInit, OnChanges {
